...
class BtcPaymentURITests: XCTestCase {
    ...
    func testParse() {
        let u1 = BtcPaymentURI(fromStr: "bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W")
        ...
        let u2 = BtcPaymentURI(fromStr: "bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?label=Luke-Jr")
        ...
        let u3 = BtcPaymentURI(fromStr: "bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?amount=0.03452")
        XCTAssertEqual(u3?.address, "175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W")
        XCTAssertEqual(u3?.amount, Decimal(string: "0.03452"))
        
        let u4 = BtcPaymentURI(fromStr: "bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?amount=50&label=Luke-Jr&message=Donation%20for%20project%20xyz")
        ...
        let u5 = BtcPaymentURI(fromStr: "bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?amount=100&user=Vasya")
